...
enum PWM_IDX {      // STM32F4                  AVR32
	...
	PWM_IDX12,      // Timer 4 CH1 - PB6
	PWM_IDX13,      // Timer 4 CH2 - PB7
	PWM_IDX14,      // Timer 4 CH3 - PB8
	PWM_IDX15       // Timer 4 CH4 - PB9
};
...
public:
	 ...
	 */
	int init(int frequency = 1000, int increments = 100);
     ...
     */
    int write(unsigned int pulseWidthInIncs);			// 0 ... +increments
