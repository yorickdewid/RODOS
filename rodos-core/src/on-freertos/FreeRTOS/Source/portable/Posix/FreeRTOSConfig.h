...
#define configTOTAL_HEAP_SIZE			( ( size_t )  41943040) /* 40 MB, This parameter has no effect when heap_3.c is included in the project. */
...
/* Definitions made to include optionally provided timer. Added by OFr. */
