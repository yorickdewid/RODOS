...
{
    // Config uart3.UART3_RX_DATA to pad EIM_DATA25(G22)
    // HW_IOMUXC_SW_MUX_CTL_PAD_EIM_DATA25_WR(0x00000002);
    // HW_IOMUXC_SW_PAD_CTL_PAD_EIM_DATA25_WR(0x0001B0B0);
    // HW_IOMUXC_UART3_UART_RX_DATA_SELECT_INPUT_WR(0x00000000);
    // Mux Register:
    ...
    HW_IOMUXC_UART3_UART_RX_DATA_SELECT_INPUT_WR(
            BF_IOMUXC_UART3_UART_RX_DATA_SELECT_INPUT_DAISY_V(EIM_DATA24_ALT2));

    // Config uart3.UART3_TX_DATA to pad EIM_DATA24(F22)
