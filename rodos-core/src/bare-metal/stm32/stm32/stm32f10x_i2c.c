 ...
 *    and returns STM32_ERROR if one or more flags are missing in the current status.
 *    - When to use:
...
/**
  ...
  * - STM32_ERROR: Last event is different from the I2C_EVENT
  */
ErrorStatus I2C_CheckEvent(I2C_TypeDef* I2Cx, uint32_t I2C_EVENT)
{
  ...
  {
    /* STM32_ERROR: last event is different from I2C_EVENT */
    status = STM32_ERROR;
  }
  /* Return status */
  return status;
